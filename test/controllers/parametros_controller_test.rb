...
class ParametrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post parametros_url, params: { parametro: { param_nome: @parametro.param_nome, param_tipo: @parametro.param_tipo, req_id: @parametro.req_id } }
    end
  ...
  test "should update parametro" do
    patch parametro_url(@parametro), params: { parametro: { param_nome: @parametro.param_nome, param_tipo: @parametro.param_tipo, req_id: @parametro.req_id } }
